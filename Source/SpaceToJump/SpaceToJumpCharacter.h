...
#include "SpaceToJumpCharacter.generated.h"

UCLASS(config=Game)
class ASpaceToJumpCharacter : public ACharacter
{
	...
	TSubclassOf<class ASpaceToJumpProjectile> ProjectileClass;
...
protected:
	...
	/** Logic to jump off the current platform */
	void OnPlatformJump();
